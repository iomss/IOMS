<template>
  ...
  >
    ...
    <el-row class="dialog-form-const-add">
      ...
      <el-form ref="form" :model="approval_form" label-width="110px" size="small" :inline="true">
        <el-form-item label="收费站/隧道所意见" class="applicationform-box">

          <template>
            <el-radio v-model="approval_form.status" label="1">通过</el-radio>
            <el-radio v-model="approval_form.status" label="2">不通过</el-radio>
          </template>

          <el-input v-model="approval_form.desc" type="textarea" />
          <div>提示：工程方案、数量、质量、主要材料设备的核实情况</div>
        </el-form-item>

        <el-form-item label="分中心意见" class="applicationform-box">
        ...
        <el-form-item label="路网中心意见" class="applicationform-box">
        ...
        <el-form-item label="分管领导意见" class="applicationform-box">
