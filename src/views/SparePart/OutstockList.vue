            ...
            <el-dialog title="新增备件出库单" :visible.sync="FormVisible" :close-on-press-escape="false" :close-on-click-modal="false" width="1000px">
              <el-form ref="EditForm" :model="EditForm" :rules="FormRules" label-width="120px">
                ...
                <el-form-item label="出库日期" prop="name">
                  <el-select v-model="EditForm.modelId" filterable remote :remote-method="remoteMethodmodelId" :loading="loading" placeholder="出库日期" size="small" @focus="remoteMethodmodelId">
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="success" size="small" @click="deleteData()">确认出库</el-button>
