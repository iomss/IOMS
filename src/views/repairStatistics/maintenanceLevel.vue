...
export default {
  ...
  methods: {
    ...
    // 图表统计
    system() {
      this.$axios.get(`/api/OperationStatistic/GetRepairLevelCount?positionId=${this.formData.positionId}&beginTime=${this.formData.beginTime}&endTime=${this.formData.endTime}`).then(res => {
